...
const AboutUs = () => {
    return (
        <div className="bg-gray-100 py-10">
            ...
            {/* Who We Are and What We Do Section - Grid Layout */}
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white shadow-lg py-16 shadow-gray-300/50">
            ...
            {/* Mission and Why Choose Us Section - Grid Layout */}
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white py-16">
                <div className="px-6 text-center">
