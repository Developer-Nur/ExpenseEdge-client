  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto text-center">
        {/* Title */}
        <h2 className="text-4xl font-bold text-EEPrimary mb-4">
          Our Features
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => (
            <div key={feature.id} className="card shadow-lg p-6 rounded-lg bg-white">
        ...
        {/* Call to Action */}
        <div className="mt-12">
          <a href="/features" className="btn bg-EEPrimary text-white">
            Learn More
          </a>
        </div>
      </div>
